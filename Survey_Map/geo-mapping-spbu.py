...
# Read the Excel file
excel_path = "/Users/athamawardi/Desktop/Research-Projects/PSE_Pertamina/Survey_Map/lokasi_spbu:n.xlsx"
        ...
        function setupSelectAll(groupId, filterClass) {{
            ...
            if (selectAll && filters.length > 0) {{
                selectAll.addEventListener('change', function() {{
                    ...
                    updateFilteredData();
                    if (updateMarkerVisibility) updateMarkerVisibility();
                }});
...
# Write HTML file
output_path = "/Users/athamawardi/Desktop/Research-Projects/PSE_Pertamina/Survey_Map/spbu_map.html"
